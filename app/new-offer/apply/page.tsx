    ...
    <main className="bg-white min-h-screen flex flex-col">
      ...
      <header className="w-full flex items-center justify-between py-3 md:py-5 px-5 md:px-6 max-w-4xl mx-auto">
        ...
        <div className="flex flex-col items-center gap-1.5">
          <Image src="/logo.png" alt="Solar Scaler" width={52} height={52} />
          <span
            className="font-black uppercase tracking-[0.05em] select-none text-[var(--tx)]"
            style={{ fontFamily: 'var(--font-mono)', fontSize: 'clamp(13px, 1.8vw, 18px)' }}
          >
            SOLAR SCALER
          </span>
        </div>
