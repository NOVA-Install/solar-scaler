...
const power3out = [0.16, 1, 0.3, 1] as const
const power2out = [0.25, 0.46, 0.45, 0.94] as const
...
function SpotsBadge() {
  ...
  return (
    <motion.div
      initial={{ opacity: 0 }}
      animate={{ opacity: 1 }}
      transition={{ duration: 0.5, ease: power3out, delay: 0.1 }}
...
function ProofStats() {
  ...
  return (
    <motion.div
      ...
      transition={{ duration: 0.6, ease: power2out, delay: 0.52 }}
      ...
      <div className="w-full max-w-2xl mx-auto px-6 pt-10 md:pt-14 pb-8 flex flex-col items-center text-center">
        ...
        >
          <motion.span
            ...
            animate={{ opacity: 1, y: 0 }}
            transition={{ duration: 0.7, ease: power3out, delay: 0.2 }}
          >
            More installs. Less chasing.
          </motion.span>
          <motion.span
            data-headline-line
            className="block whitespace-nowrap text-white/70"
            initial={{ opacity: 0, y: 12 }}
            animate={{ opacity: 1, y: 0 }}
            transition={{ duration: 0.7, ease: power3out, delay: 0.32 }}
          >
        ...
        <motion.a
          ...
          initial={{ opacity: 0 }}
          animate={{ opacity: 1 }}
          transition={{ duration: 0.5, ease: power3out, delay: 0.62 }}
        ...
        <motion.div
          initial={{ opacity: 0 }}
          animate={{ opacity: 1 }}
          transition={{ duration: 0.5, ease: power3out, delay: 0.74 }}
